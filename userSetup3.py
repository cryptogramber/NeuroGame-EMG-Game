...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.label_5 = wx.StaticText(self, -1, "Step 3: Attach two electrodes to the underside of your forearm, \na few inches below your elbow. Point both of the snaps upward.", style=wx.ALIGN_CENTRE)
        self.bitmap_1 = wx.StaticBitmap(self, -1, wx.Bitmap("./images/3_flexor.JPG", wx.BITMAP_TYPE_ANY))
        self.button_3 = wx.Button(self, -1, "<< Back")
        self.button_4 = wx.Button(self, -1, "Next >>")
    ...
    def __set_properties(self):
        self.SetTitle("Attach Flexor (Underside) Electrodes")
