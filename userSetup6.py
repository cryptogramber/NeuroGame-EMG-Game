...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.label_5 = wx.StaticText(self, -1, "Step 6: Connect the two yellow snaps to the electrodes on the \nunderside of your forearm. Drape the wires over your arm.", style=wx.ALIGN_CENTRE)
        self.bitmap_1 = wx.StaticBitmap(self, -1, wx.Bitmap("./images/6_flexor_w.JPG", wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        self.SetTitle("Attach Yellow (Flexor) Wire Snaps")
