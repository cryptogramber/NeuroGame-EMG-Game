...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.label_5 = wx.StaticText(self, -1, "Make sure your mouse or clicker is plugged into the computer.", style=wx.ALIGN_CENTRE)
        self.bitmap_1 = wx.StaticBitmap(self, -1, wx.Bitmap("./images/4_mouse_big.JPG", wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        self.SetTitle("Plug Mouse or Clicker Into Computer")
