...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.bitmap_4 = wx.StaticBitmap(self, -1, wx.Bitmap("./images/ngbegin.png", wx.BITMAP_TYPE_ANY), style=wx.NO_BORDER)
        self.bitmap_button_1 = wx.BitmapButton(self, -1, wx.Bitmap("./images/startneurogame.png", wx.BITMAP_TYPE_ANY), style=wx.NO_BORDER)
...
# ~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~+-~ 
    def __set_properties(self):
        self.SetTitle("NeuroGame pre-Session Reminders")
