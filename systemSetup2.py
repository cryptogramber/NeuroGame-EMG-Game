...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.label_5 = wx.StaticText(self, -1, "If your NeuroGame box was charging, unplug the charging cable.", style=wx.ALIGN_CENTRE)
        self.bitmap_1 = wx.StaticBitmap(self, -1, wx.Bitmap("./images/2_ngpower_big.JPG", wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        self.SetTitle("Unplug NeuroGame Power Cable")
