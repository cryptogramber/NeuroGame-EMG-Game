...
class MyDialog(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.label_5 = wx.StaticText(self, -1, "Step 5: Connect the two blue snaps to the electrodes on top \nof your forearm. Drape the wires toward you.", style=wx.ALIGN_CENTRE)
        self.bitmap_1 = wx.StaticBitmap(self, -1, wx.Bitmap("./images/5_extensor_high.JPG", wx.BITMAP_TYPE_ANY))
    ...
    def __set_properties(self):
        self.SetTitle("Attach Blue (Extensor) Wire Snaps")
